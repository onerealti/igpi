...
#section("Activity")[
  ...
  - *Static Torque:*
    #formula-block(
      ...
      caption: "Static Load Torque Calculation"
    )
  - *Required Torque:*
    #formula-block(
      $ T_"required" = T_s times "SF" = 4.0 times 1.5 = 6.0 "kg-cm" $,
      caption: "Design Torque (with Safety Factor)"
    )
  ...
  - *Stress:*
    #formula-block(
      ...
      caption: "Compressive Stress on Pillar Shaft"
    )
