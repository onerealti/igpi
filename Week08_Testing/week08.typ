...
#section("Activity")[
  ...
  - *Sensitivity Test:* We used a variable LUX lamp at #box([15°]) offsets. The tracking algorithm reacted at an analog sensor difference of >15. Under overcast sky simulations, this low threshold caused the servos to jitter (hunt). Increasing the threshold to 20 improved tracking stability.
  - *Precision Test:* Measured alignment errors using the shadow length of a peg mounted perpendicular to the panel. We recorded an average angular error of #box([$\pm 3.5^o$]) (well within our #box([$\pm 5^o$]) design target).
  - *Power Consumption:*
  ...
  #align(center)[
    #table(
      ...
      [Wire Fatigue], [Wires twisted #box([180°]) during panning.], [Short circuit risk.], [Add software rotation limits (#box([180°])).],
