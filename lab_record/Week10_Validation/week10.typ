...
#section("Activity")[
  ...
  - *Assumptions:* Panel mass $m = 0.8\text{ kg}$, pivot-to-CG distance $r = 0.05\text{ m}$, gravity $g = 9.81\text{ m/s}^2$, safety factor $SF = 1.5$.
  - *Static Torque:*
    $$T_s = m times g times r = 0.8 times 9.81 times 0.05 = 0.3924\text{ Nm} approx 4.0\text{ kg-cm}$$
  - *Required Torque:*
    $$T_{\text{required}} = T_s times SF = 4.0 times 1.5 = 6.0\text{ kg-cm}$$
  - *Validation:* The MG995 servo provides $10.0\text{ kg-cm}$ stall torque at 4.8V. Since $10.0 > 6.0$, the servo is **sufficient**.

  === 3. Compressive Stress on Central Shaft
  - *Assumptions:* Total assembly mass $M = 1.5\text{ kg}$, shaft diameter $d = 10\text{ mm}$ ($r_s = 0.005\text{ m}$), Area $A = pi times r_s^2 = 7.85 times 10^{-5}\text{ m}^2$.
  - *Stress:*
    $$sigma = F / A = (1.5 times 9.81) / (7.85 times 10^{-5}) approx 0.187\text{ MPa}$$
  - *Validation:* The yield strength of printed PLA is $30\text{ - }50\text{ MPa}$. Compressive stress ($0.187\text{ MPa}$) is well within safety limits.
  ...
  - *Wind Force:*
    $$F_w = 1/2 times rho times v^2 times A times C_d = 0.5 times 1.225 times 10^2 times 0.05 times 1.2 approx 7.35\text{ N}$$
  - *Wind Torque:*
    $$T_w = F_w times r_w = 7.35 times 0.05 = 0.3675\text{ Nm} approx 3.75\text{ kg-cm}$$
  - *Worst-case Torque:*
    $$T_{\text{total}} = T_s + T_w = 4.0 + 3.75 = 7.75\text{ kg-cm} < 10.0\text{ kg-cm}\text{ (Servo Limit).}$$
